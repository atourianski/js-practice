...
function day(D3, tumeric, bComplex, fish, Mag, vitC, vitE, iron, food, coffee, bottled, tap, alcohol, exercise, cycle, notes){
	...
	//menstrual cycle
	this.cycle = "<li class = 'list-group-item'><b>Cycle:</b>&nbsp&nbsp" + cycle + "</li>"
	//notes
...
var o = document.getElementById("cycle").value;
var p = document.getElementById("notes").value;
var today = new day(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p);
results.push(today);
console.log(results);
